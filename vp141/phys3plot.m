...
function se_slope = manual_slope_se(x, y)
    n = length(x);
    X = [ones(n, 1), x];  % Design matrix (includes intercept)
...
se_slope = manual_slope_se(A_squared, v_squared);
% disp(['Standard Error of the Slope: ', num2str(se_slope)]);
